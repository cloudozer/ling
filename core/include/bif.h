...
// binary:longest_common_suffix/1 [61]
term_t cbif_longest_common_suffix1(proc_t *proc, term_t *regs);
// binary:longest_common_prefix/1 [62]
...
// ling:experimental/2 [178]
term_t cbif_experimental2(proc_t *proc, term_t *regs);
// ling:profile_display/0 [179]

...
ex_utf16_illegal_sequences_bif(Config) when is_list(Config) ->
    ...
    %%MK: ?line leading_lo_surrogate_bif(16#DC00, 16#DFFF),
    ?line leading_lo_surrogate_bif(16#DCF0, 16#DCFF),
    ?line leading_lo_surrogate_bif(16#DFF0, 16#DFFF),
...
ex_utf8_illegal_sequences_bif(Config) when is_list(Config) ->
    ...
    %% Short sequences.
    %%MK: ?line short_sequences_bif(16#80, 16#10FFFF),
    ?line short_sequences_bif(16#80, 16#FFF),
    ?line short_sequences_bif(16#10F000, 16#10FFFF),
...
setlimit(X) ->
	io:format("Setting 'unicode_loop_limit' to ~w ignored\n", [X]).
